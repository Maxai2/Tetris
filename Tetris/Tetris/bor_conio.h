 ...
 *
 *      Copyright (c) 1987, 2011 by Embarcadero Technologies, Inc.
 *      All Rights Reserved.
 *
 */
...
#if !defined(__BOR_CONIO_H)
#define __BOR_CONIO_H
...
extern unsigned int _wscroll;

#ifdef __cplusplus
extern "C" {
#endif

void        _RTLENTRY _EXPFUNC OpenBorConio(void);
void        _RTLENTRY _EXPFUNC CloseBorConio(void);
...
//int         _RTLENTRY _EXPFUNC cvprintf( const char *__format, void *__arglist );
//int         _RTLENTRY _EXPFUNC cscanf( const char *__format, ... );
//int         _RTLENTRY _EXPFUNC cvscanf( const char *__format, void *__arglist );
